...
public class OBJImportSettingsPanel extends JPanel {
	...
	public OBJImportSettingsPanel(final Build builder) {
		...
		final Font smallFont = LocalizedFontHelper.getSansFont(Font.BOLD, 16);
		final Font medFont = LocalizedFontHelper.getSansFont(Font.BOLD, 28);
		final Font bigFont = LocalizedFontHelper.getSansFont(Font.BOLD, 46);
	}
